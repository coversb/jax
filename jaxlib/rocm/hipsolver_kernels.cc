    ...
    switch (d.type) {
      case HipsolverType::F32: {
        JAX_RETURN_IF_ERROR(JAX_AS_STATUS(hipsolverSpotrfBatched(
            ...
            static_cast<float*>((float*)((unsigned char*)workspace + (d.batch * sizeof(float*)))), d.lwork,
            info, d.batch)));
        break;
      }
      case HipsolverType::F64: {
        JAX_RETURN_IF_ERROR(JAX_AS_STATUS(hipsolverDpotrfBatched(
            ...
            static_cast<double*>((double*)((unsigned char*)workspace + (d.batch * sizeof(double*)))), d.lwork,
            info, d.batch)));
        break;
      }
      case HipsolverType::C64: {
        JAX_RETURN_IF_ERROR(JAX_AS_STATUS(hipsolverCpotrfBatched(
            ...
            static_cast<hipFloatComplex*>((hipFloatComplex*)((unsigned char*)workspace + (d.batch * sizeof(hipFloatComplex*)))),d.lwork,
            info, d.batch)));
        break;
      }
      case HipsolverType::C128: {
        ...
        JAX_RETURN_IF_ERROR(JAX_AS_STATUS(hipsolverZpotrfBatched(
            ...
            static_cast<hipDoubleComplex*>((hipDoubleComplex*)((unsigned char*)workspace + (d.batch * sizeof(hipDoubleComplex*)))), d.lwork,
            info, d.batch)));
        break;
      }
    }
