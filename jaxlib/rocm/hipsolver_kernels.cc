...
class SyevjInfoHandle
{
public:
  SyevjInfoHandle(hipsolverSyevjInfo_t& p) : p_(p) {}
  ~SyevjInfoHandle() { hipsolverDestroySyevjInfo(p_); }

private:
  hipsolverSyevjInfo_t& p_;
};
...
absl::Status Syevj_(hipStream_t stream, void** buffers, const char* opaque,
  ...
  SyevjInfoHandle hp(params);

  //std::unique_ptr<hipsolverSyevjInfo_t, void (*)(hipsolverSyevjInfo_t*)> params_cleanup(
